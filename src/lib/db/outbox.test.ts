...
describe("clearAllData and the outbox", () => {
  it("never clears the outbox — a pending sync operation survives a destructive cloud pull", async () => {
    ...
    await putItem({ identity: "item-1", itemType: "food", rawName: "Apple", category: "Fruit", categoryId: null, isArchived: false, createdDate: "2026-01-01", reminderTime: null, unit: null });
