...
export const POLAND_SEASONAL_PRODUCE: Record<number, string[]> = {
  ...
  5: ["Asparagus", "Kohlrabi", "Peas", "Carrot", "Spinach", "Radish", "Strawberries", "Rhubarb", "Gooseberry"],
  6: ["Zucchini", "Broccoli", "Cauliflower", "Kohlrabi", "Cucumber", "Tomato", "Strawberries", "Cherry", "Gooseberry", "Raspberries"],
  7: ["Eggplant", "Broccoli", "Cauliflower", "Fennel", "Cucumber", "Tomato", "Pepper", "Cherry", "Currant", "Blueberries", "Plum"],
  8: ["Eggplant", "Zucchini", "Corn", "Pepper", "Tomato", "Raspberries", "Blueberries", "Peach", "Plum", "Blackberry"],
