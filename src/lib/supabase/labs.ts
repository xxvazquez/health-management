...
/** Same "is cloud set up" flag as the rest of Doctors — a lab result only
 * exists once it's saved to your account, no offline/local-only mode. */
export const labsConfigured = supabaseConfigured;
