 ...
 */
const BRISTOL_PATHS: Record<number, ReactNode> = {
  1: (
    <>
  ...
  4: <rect x="4.5" y="10.5" width="19" height="7" rx="3.5" />,
  5: (
    <>
...
export function BristolIcon({ score, size = 28 }: { score: number; size?: number }) {
  const paths = BRISTOL_PATHS[score];
