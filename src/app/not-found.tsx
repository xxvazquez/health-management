...
export default function NotFound() {
  return (
    <div
      className="flex min-h-[70vh] flex-col items-center justify-center rounded-2xl border bg-cover bg-center px-6 py-16 text-center"
    ...
    >
      ...
      <Link
        href="/"
        className="mt-6 rounded-full px-5 py-2 text-sm font-medium whitespace-nowrap text-white"
